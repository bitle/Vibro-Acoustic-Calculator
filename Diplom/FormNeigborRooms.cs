...
namespace Diplom
{
    public partial class FormNeigborRooms : Form
    {
        public FormNeigborRooms()
        {
            InitializeComponent();
            ...
            absorbers.Add(new RowFloat("Ковер на подкладке", new double[] { 0.1, 0.15, 0.25, 0.3, 0.4, 0.4, 0.4 }));
        ...
        public FormNeigborRooms(CPNeighbor data) : this()
        {
        ...
        private void FormNeigborRooms_Load(object sender, EventArgs e)
        {
        ...
        private double L(int freq)
        {
            ...
            {
                MessageBox.Show("Неправильна введена площадь смежного помещения");
                throw new Exception();
            }
            switch (cbRoomType.SelectedIndex)
            {
                ...
                case 3:
                    ...
                    break;
                default:
                    MessageBox.Show("Не выбран тип смежного помещения");
                    throw new Exception();
            }
            ...
            {
                MessageBox.Show("Неправильно введена Эквивалентная площадь звукопоглащения потребителя");
                throw new Exception();
            }
            ...
            if (k < 1) k = 1;
            return L_ist - 10 * Math.Log10(Sz / Szt) + 10 * Math.Log10(Sz) - 10 * Math.Log10(B1000 * mu) - 10*Math.Log10(k);
        }
        ...
        private void rbStrongNoiseReduction_CheckedChanged(object sender, EventArgs e)
        {
